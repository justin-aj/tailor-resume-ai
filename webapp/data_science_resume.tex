...
\begin{center}
    ...
    \href{https://justin-aj.github.io/}{\underline{justin-aj.github.io}} 
...
\section{Experience}
  ...
  \resumeSubheading
      {\textcolor{blue}{Machine Learning Co-op}}{\textbf{Jun 2025 -- Present}}
      {\normalfont \textbf{AARP, National Office}}
      {Washington DC, USA}
      \resumeItemListStart
\resumeItem{Developed a gradient boosting model to personalize premium digital offers, boosting AARP auto-renewal conversions by 7\% through targeted customer scoring (details in the \textbf{Projects} section).}


      \resumeItem{Built ML model performance monitoring framework in \textbf{Databricks} using \textbf{PySpark}, \textbf{SQL}, tracking key metrics such as AUC, KS, lift across \textbf{25+ production models} for real-time drift detection, model health monitoring.}


    \resumeItemListEnd
    
      \resumeSubheading
      {\textcolor{blue}{NLP Graduate Research Assistant}}{\textbf{Jan 2025 -- Apr 2025}}
...
\resumeItem{Benchmarked LLMs in 5-class financial classification.}
...
{\textbf{Transition-to-Auto-Renew (TTAR) Predictive Model} $|$ \emph{Databricks, PySpark}}{\textbf{Sept 2025 -- Present}}
\resumeItemListStart
\resumeItem{Architected ML scalable pipeline to process, clean 3,000+ features; performed model-based feature selection using Gradient Boosting Trees PySpark for optimal predictor identification.}
\resumeItem{Enhanced ML pipeline(skewness-aware imputations, log-scaling, variance filtering) to stabilize inputs, reduce drift.}
\resumeItem{Handled class imbalance with \textbf{weighted loss, feature importance} pruning to improve minority class sensitivity.}
\resumeItem{Benchmarked LR, GBM, RF (TrainValidation PySpark) on 5M samples; GBM achieved the best PR-AUC score.}
\resumeItem{Improved F1 and AUC-PR by 5-8\%, supporting incremental lifts in conversion and retention post-deployment.}
\resumeItemListEnd
